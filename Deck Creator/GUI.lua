...
function GUI.registerGlobals()
    ...
    G.FUNCS.DeckCreatorModuleOpenGithub = function()
        love.system.openURL("https://www.mrballs.com/")
    end
    ...
    G.FUNCS.DeckCreatorModuleCopyDeck = function(args)
        -- Deck copying disabled - only sharing custom decks is available
        Utils.log("Deck copying has been disabled. Only sharing custom decks is available.")
    end

    G.FUNCS.DeckCreatorModuleEditDeck = function(args)
        -- Deck editing disabled - only sharing custom decks is available
        Utils.log("Deck editing has been disabled. Only sharing custom decks is available.")
    end
    ...
    G.FUNCS.DeckCreatorModuleOpenCreateDeck = function()
        -- Deck creation disabled - only sharing custom decks is available
        Utils.log("Deck creation has been disabled. Only sharing custom decks is available.")
    end
